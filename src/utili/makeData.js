...
import { ButtonNftIpf } from "./components/ButtonIpfNft"
...
// For generating dummy table or loading csv data
const newPerson = (pre, post, csv) => {
  ...
  return {
    ...
    year: 2022,
    currentCert: <ButtonNftIpf cert={{
      date: "12 May 2022",
      ipf: ipfLink,
      nft: NFTLink,
    }} />,
    prevCert: <ButtonNftIpf cert={{
      date: "11 May 2022",
      ipf: ipfLink,
      nft: NFTLink,
    }} />,
    history: <ButtonDownload history={pdfLink} />
  }
}
  ...
  if (lens[4] && lens[4]?.length > 0) {
    ...
    lens[4].map((d, i) => {
      ...
      const currCert = {
        ...
        ipf: linkArray[i]?.ipf ?? dumWeb,
        nft: linkArray[i]?.nft ?? dumWeb
      }
      ...
      const history = linkArray[i]?.pdf ?? dumWeb
      ...
      const a = {
        ...
        year: 2022,
        currentCert: <ButtonNftIpf cert={currCert} />,
        prevCert: <ButtonNftIpf cert={prevCert} />,
        history: <ButtonDownload history={history} />,
        subRows: []
      }
